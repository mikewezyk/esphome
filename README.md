...
- Future Idea: Because intake and exhaust fans have different fan curves, create a mapping at voltage ranges to replace the linear relationship and account for static pressure differences. test
